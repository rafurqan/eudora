...
class CreateStudentRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'transportation_mode_id' => 'nullable|uuid|exists:transportation_modes,id',
            'child_order' => 'nullable|integer|min:1',
            'family_status' => 'nullable|string|max:50',
            'special_need_id' => 'nullable|uuid|exists:special_needs,id',
            'special_condition_id' => 'nullable|uuid|exists:special_conditions,id',
            ...
            'origin_schools.*.education_level_id' => 'required|uuid|exists:education_levels,id',
            'origin_schools.*.school_type_id' => 'required|uuid|exists:school_types,id',
            ...
            'documents.*.document_type_id' => 'required|uuid|exists:document_types,id',
            'documents.*.file' => ['required', 'string', new Base64File],

            // Student Contacts
            'contacts' => 'nullable|array',
            'contacts.*.value' => 'required|string',
            'contacts.*.contact_type_id' => 'required|uuid|exists:document_types,id',
            ...
            'parents.*.education_level_id' => 'nullable|uuid|exists:education_levels,id',
            'parents.*.occupation' => 'nullable|string',
            'parents.*.income_range_id' => 'nullable|uuid|exists:income_ranges,id',
